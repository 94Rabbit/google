    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-interval="3000">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="//5ororwxhmplorik.ldycdn.com/cloud/iqBqjKmrRinSilmilqlo/lunbo.jpg" alt="...">
        </div>
        <div class="item">
          <img src="//5ororwxhmplorik.ldycdn.com/cloud/iqBqjKmrRinSilmilqlo/lunbo.jpg" alt="...">
        </div>
...
<!--        </div>-->
        <div class="col-xs-12 col-sm-12 col-md-6">
          <h2 class="bigData-title">
            HOT PRODUCTS
            <small>/  We provide good quality machines and services at affordable price</small>
          </h2>
  ...
  export default {
    ...
    data() {
      return {
        swiperList: [
          {
            img: '//5qrorwxhmploiik.ldycdn.com/cloud/ikBqjKmrRinSiljilrln/lunbo.jpg',
            path: "",
            title: '',
            content: '',
          },
          ...
          {
            img: '//5ororwxhmplorik.ldycdn.com/cloud/iqBqjKmrRinSilmilqlo/lunbo.jpg',
            path: "",
            title: '',
            content: '',
          },
